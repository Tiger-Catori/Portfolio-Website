  ...
  return (
    <div className="footer-col col-two">
      ...
      <ul className="footer-links social-links">
        <li><a target="_blank" rel="noreferrer" href="https://www.facebook.com"><ion-icon name="logo-facebook"></ion-icon>Facebook</a></li>
        <li><a target="_blank" rel="noreferrer" href="https://www.instagram.com"><ion-icon name="logo-instagram"></ion-icon>Instagram</a></li>
        <li><a target="_blank" rel="noreferrer" href="https://www.twitter.com"><ion-icon name="logo-twitter"></ion-icon>Twitter</a></li>
        <li><a target="_blank" rel="noreferrer" href="https://web.telegram.org/a/"><ion-icon name="navigate-circle-outline"></ion-icon>Telegram</a></li>
      </ul>
    </div>
  );
};
